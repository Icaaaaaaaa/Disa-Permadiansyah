    ...
    <AdminLayout activePage="projects">
                  ...
                  {project.category && (
                    <div className="mb-3">
                      <span className={`px-3 py-1 text-xs rounded-full font-medium ${
                        project.category === 'Project' ? 'bg-blue-500/20 text-blue-300' :
                        project.category === 'Design' ? 'bg-blue-500/20 text-blue-300' :
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 z-50 overflow-y-auto">
          <div className="bg-[#0f1729] border border-white/10 rounded-xl w-full max-w-3xl my-8">
