    ...
    <AdminLayout activePage="certificates">
      ...
      {showModal && (
        <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center p-4 z-50 overflow-y-auto">
          <div className="bg-[#0f1729] border border-white/10 rounded-xl w-full max-w-md my-8 max-h-[90vh] flex flex-col">
            ...
            <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <label
                      ...
                      className="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-white/20 rounded-lg cursor-pointer hover:border-blue-500 transition-colors bg-white/5"
                    >
                      {imageFile ? (
                        <div className="text-center">
              ...
              {((uploadMethod === 'url' && imageUrl) || (uploadMethod === 'file' && imageFile)) && (
                <div className="border border-white/10 rounded-lg p-4">
                  ...
                  />
                  <p 
                    className="text-blue-400 text-sm text-center py-4"
                    style={{ display: 'none' }}
                  >
              ...
              <div className="flex gap-3 p-6 border-t border-white/10 bg-[#0f1729] flex-shrink-0">
                <button
                  type="button"
                  onClick={handleCloseModal}
