...
const SocialLinks = () => {
  const [socialLinks, setSocialLinks] = useState([
    ...
    },
    {
      ...
      subText: "@fazrilukman",
      icon: Youtube,
      url: "https://www.youtube.com/@fazrilukman",
      color: "#FF0000",
    ...
    },
    {
      ...
      subText: "@Fazrilukman",
      icon: Github,
      url: "https://github.com/Fazrilukman",
      color: "#ffffff",
    ...
    const fetchProfile = async () => {
      ...
      try {
        const { data, error } = await supabase
          ...
          .select('linkedin_connect, instagram_connect, youtube_connect, github_connect, tiktok_connect')
          .eq('id', 1)
          .single();
        ...
        if (data) {
          setSocialLinks(prev => prev.map(link => {
            switch(link.name) {
              ...
              case 'YouTube':
                return data.youtube_connect ? { ...link, url: data.youtube_connect } : link;
              case 'GitHub':
